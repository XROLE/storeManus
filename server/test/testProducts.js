...
describe('PRODUCTS SECTION', () => {
        ...
        it('Edit product without access token', (done) => {
            chai.request(server)
                ...
                .end((err, res) => {
                    ...
                    expect(res).to.be.an('object');
                    expect(res.body).to.have.property('Success').eql(false);
                    expect(res.body).to.have.property('Message').eql('Unauthorized user access. Please make sure you are signed in');
                    done();
                });
        });
    ...
    describe('GET \'/api/v1/products\'', () => {  // GET ALL PRODUCTS PASSED WITHOUT ID
        it('Get Products without token', (done) => {
            chai.request(server)
                .get('/api/v1/products')
                .end((err, res) => {
                    expect(err).to.be.null;
        ...
        it('Get one Product with id that is not numeric', (done) => {
            chai.request(server)
        ...
        it('Get one Product without acess token', (done) => {
            chai.request(server)
                .get('/api/v1/product/1')
                .end((err, res) => {
                    expect(err).to.be.null;
